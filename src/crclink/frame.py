...
from .crc16_xmodem import crc16_xmodem
...
def _crc(data: bytes) -> int:
    """Compute the transport CRC over data with the vendored crc16-xmodem.

    The ``crc16_xmodem`` module is generated by crcglot and vendored into the
    wheel, so framing has no runtime dependency. See docs/crcglot-integration.md.
    """
